...
class UP4AbilitySystemComponent;
...
/**
 * This Task is yoinked from GASDocumentation, thanks man
 */
UCLASS()
class PROJECT4_API UPlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
private:
	...
	UP4AbilitySystemComponent* GetTargetASC();
